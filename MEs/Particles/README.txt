README PARTICLES ver. 0.01 for MC3.0

- Run with Csound 6.10.0 (64-bit). The Csound install needs to be done with python opcodes (Python 2.7 must be pre-installed)
